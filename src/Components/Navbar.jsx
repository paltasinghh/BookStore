...
function Navbar() {
  ...
  return (
   ...
   <div className={`max-w-screen-2x1 container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
    sticky? "sticky-navbar shadow-md bg-slate-800 dark:bg-slate-600 dark:text-white duration-300 transition-all ease-in-out" :""
   }`}
   >
  ...
  <div className="navbar-start">
    ...
    <a className=" text-x2 md:text-xl  font-bold cursor-pointer">Book Store</a>
  </div>
